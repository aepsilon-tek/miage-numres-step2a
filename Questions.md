...
Réponse:
On reçoit deux réponses avec plusieurs chaps classique comme leur id, de la traduction et des thèmes.
...
Réponse: De même que pour la question, on reçoit les réponse attendues ainsi que leurs attributs.
